...
package com.tformacion.adapterbasico.adapters;
...
public class AndroidVersionsAdapter extends BaseAdapter {
    ...
    private static final String TAG = AndroidVersions.class.toString();
    private static int convertViewCounter = 0;

    public AndroidVersionsAdapter(Context context, ArrayList<AndroidVersions> versions) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AndroidVersions versions = (AndroidVersions) getItem(position);
