...
import es.tformacion.basicadapter.adapters.AndroidVersionsAdapter;
...
public class AndroidVersionsFragment extends ListFragment {
    ...
    public AndroidVersionsFragment() {
        ...
        myMCML = new MultiChoiceModeListener() {
            ...
            public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
                ...
                } else if (i1 == R.id.select_all_entry) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.basic_adapter_fragment_main, container, false);
